...
| `RATE_LIMIT_PER_DAY` | 0 | IP başına günlük export (0 = sınırsız) |
| `MAX_CONCURRENT_RENDERS` | 4 | Eşzamanlı render; fazlası kuyruğa girer |
...
docker build -t sas-render .
docker run -p 8080:8080 -e RATE_LIMIT_PER_DAY=0 sas-render
